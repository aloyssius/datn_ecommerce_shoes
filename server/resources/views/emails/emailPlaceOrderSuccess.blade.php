                                ...
                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                    ...
                                    <tr>
                                        <td align="center" valign="top"
                                            ...
                                            class="mobile-center">
                                            <img src="https://res.cloudinary.com/dgupbx2im/image/upload/v1721838403/products/ltxmvpgst73yvw1ikgfz.png"
                                                alt="" width="150">
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <tr>
                        <td align="center" style="padding: 35px 35px 20px 35px; background-color: #ffffff"
                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <tr>
                                    <td align="center"
                                        style="font-size: 16px; font-weight: bold; line-height: 24px; padding-top: 25px">
                                        <h2
                                            style="font-size: 30px; font-weight: bold; line-height: 36px; color: #333333; margin: 0">
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <p style="font-size: 16px; font-weight: 400; line-height: 24px">
                                            ...
                                            <span
                                                style="color: #ff6700; font-weight: bold; text-decoration: underline">{{ '#' . $bill->code }}</span>
                                            của bạn.
                                            ...
                                            <a href="{{ env('REACT_PATH_TRACKING_ORDER') . '?token=' . $token }}"
                                                style="font-weight: bold; color: #ff6700">vào đây</a>.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" style="padding-top: 20px">
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                            ...
                                            <tr>
                                                <td width="75%" align="left"
                                                    style="font-size: 16px; font-weight: 400; line-height: 24px; padding: 5px 10px">
                                                    Khuyến mãi
                                                </td>
                                                <td width="25%" align="left"
                                                    style="font-size: 16px; font-weight: 400; line-height: 24px; padding: 5px 10px">
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td width="50%" align="left"
                                                    style="color: #ff6700;font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px; border-top: 3px solid #333333; border-bottom: 3px solid #333333">
                                                    Tổng thanh toán
                                                </td>
                                            ...
                                            <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <td align="left" valign="top"
                                                    ...
                                                    <p style="font-size: 14px">Bất cứ lúc nào, bạn có thể tra cứu trạng
                                                        ...
                                                        <a href="{{ env('REACT_PATH_TRACK_ORDER') }}"
                                                            style="color: #ff6700; font-weight: bold">tại
                                                            link</a>
                                                    ...
                                                    <span
                                                        style="font-size: 13.5px; color: gray; display: block; margin-top: 10px">Đây
