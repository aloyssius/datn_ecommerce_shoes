...
export default function EmployeeNewEditForm({ isEdit, currentEmployee, isLoading }) {
    ...
    return (
        <>
            ...
            <EmployeeNewEditListAddress isEdit={isEdit} listAddress={currentEmployee?.addresses} />
        </>
    );
}
